...
/*extern int copen(char *device, unsigned int mask);
extern int cclose(int id);
extern int cread(int id, INT32 *buffer, int size);
extern int cwrite(int id, INT32 *buffer, int size);
extern int cioctl(int id, int request, void *args);
extern UINT32 clseek(int id, const UINT32 offset, int whence);*/


#ifdef CPLUS
extern "C" int copen(char *device, unsigned int mask);
extern "C" int cclose(int id);
extern "C" int cread(int id, INT32 *buffer, int size);
extern "C" int cwrite(int id, INT32 *buffer, int size);
extern "C" int cioctl(int id, int request, void *args);
extern "C" UINT32 clseek(int id, const UINT32 offset, int whence);
extern "C" int fgread(int id, void *buffer, int size);
extern "C" int fgioctl(int id, int request, void *args);
extern "C" int fgopen(char *device, unsigned int mask);
extern "C" int fgclose(int fd);
#else
